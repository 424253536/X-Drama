...
3369 个单测全过 / TypeScript 严格模式 / MIT 开源.
...
> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · open source · 3369 tests passing.
