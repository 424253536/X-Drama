...
>
> MIT licensed. 3369 tests passing. Self-hostable on Node 20+.
...
**Title:**
> [P] Open-sourced an 8-agent AI pipeline that turns 1 sentence into a finished short-form drama (3369 tests, MIT)
...
> ▸ MIT licensed, 3369 tests passing
>
...
> TL;DR: Sora gives you 5 seconds. We give you 30 seconds + character consistency + real Chinese subtitles + a multiplayer timeline editor. Open source. MIT. 3369 tests.
...
>
> MIT · Next.js 16 · TypeScript · 3369 tests passing
>
...
> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · MIT · 3369 tests.
