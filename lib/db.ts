...
addColumnIfMissing('projects', 'model_selections_json', "TEXT NOT NULL DEFAULT '{}'");
addColumnIfMissing('projects', 'audio_strategy', "TEXT NOT NULL DEFAULT 'separate'");
addColumnIfMissing('projects', 'routing_version', 'INTEGER NOT NULL DEFAULT 1');
